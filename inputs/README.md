...
|---|---|---|---|
| `Windows98_SE_No_Ramdrive.img` | `e50bac4bc6cd1861d908fb5aaf147644a82c7f9802b5612a33088e93106780d3` | Human-supplied Windows 98 boot floppy; no public download URL is approved | Abandonware, freely distributable. Its current system files report Win98 `4.10.1998` despite the filename. |
...
| `ne2000.com` | `69573724d30a9498f2a81d3b0ca9b79b4a326522d8aa43d111f7a9ddf047bc12` | [Crynwr packet driver collection](https://github.com/fragglet/crynwr_mirror), `binaries/ne2000.com` | Free software per Crynwr terms; keep the collection's license text (`binaries/copying.doc`) with redistributions. Optional input: deployed only when copied into `payload/DRIVERS/` for the NE2000 alternate NIC. |
